...
<?php $__env->startSection('content'); ?>
						...
						<form method="POST" action="<?php echo e(route('api.v1.borrow-room-with-college-student', []), false); ?>" class="appointment-form">
                            ...
                            <?php if($errors->isNotEmpty()): ?>
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($message == 'login_for_more_info'): ?>
                                            <a href="<?php echo e(route('admin.login'), false); ?>">Masuk</a> untuk meilihat aktivitas peminjaman.
                                        <?php else: ?>
                                            <?php echo e($message, false); ?><br>
                                        <?php endif; ?>
                            ...
                            <?php if(session('success')): ?>
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    Pinjam ruang berhasil, silahkan cek status peminjaman <a href="<?php echo e(route('admin.login'), false); ?>">disini</a>. Masuk menggunakan username dan password NIM.
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
							...
							<div class="row">
								<div class="col-md-12">
			    					...
			    					<input name="full_name" value="<?php echo e(old('full_name'), false); ?>" type="text" class="form-control" placeholder="Nama Lengkap">
			    				</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
			            		...
			            		<input id="borrow_at" name="borrow_at" value="<?php echo e(old('borrow_at'), false); ?>" type="text" class="form-control appointment_date-check-in datetimepicker-input" placeholder="Tanggal Mulai" data-toggle="datetimepicker" data-target="#borrow_at">
		            		</div>
			    				</div>
								</div>
								<div class="col-md-6">
			    					...
			    					<div class="input-wrap">
			            		<div class="icon"><span class="ion-md-calendar"></span></div>
			            		<input id="until_at" name="until_at" value="<?php echo e(old('until_at'), false); ?>" type="text" class="form-control appointment_date-check-out datetimepicker-input" placeholder="Tanggal Selesai" data-toggle="datetimepicker" data-target="#until_at">
		            		</div>
			    				</div>
								</div>
								<div class="col-md-6">
	                      ...
	                      <select name="room" id="" class="form-control">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $data['rooms']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <option value="<?php echo e($room->id, false); ?>" <?php if(old('room') == $room->id): ?> selected <?php endif; ?>>
                                    <?php echo e($room->room_type->name . ' - ' . $room->name, false); ?>
	                      ...
	                      <select name="lecturer" id="" class="form-control">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $data['lecturers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $lecturerName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <option value="<?php echo e($key, false); ?>" <?php if(old('lecturer') == $key): ?> selected <?php endif; ?>>
                                    <?php echo e($lecturerName, false); ?>
                            ...
                            <?php endif; ?>
								...
								<div class="col-md-6">
									<div class="form-group">
			    					<input name="nim" value="<?php echo e(old('nim'), false); ?>" type="text" class="form-control" placeholder="NIM">
			    				</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
	                      ...
	                      <select name="study_program" id="" class="form-control">
	                      	...
	                      	<option value="akuntansi" <?php if(old('study_program') == 'akuntansi'): ?> selected <?php endif; ?>>Akuntansi (S1)</option>
	                      	<option value="bisnis digital" <?php if(old('study_program') == 'bisnis digital'): ?> selected <?php endif; ?>>Bisnis Digital (S1)</option>
	                      	<option value="ekonomi islam" <?php if(old('study_program') == 'ekonomi islam'): ?> selected <?php endif; ?>>Ekonomi Islam (S1)</option>
	                      	<option value="ilmu ekonomi" <?php if(old('study_program') == 'ilmu ekonomi'): ?> selected <?php endif; ?>>Ilmu Ekonomi (S1)</option>
	                      	<option value="manajemen" <?php if(old('study_program') == 'manajemen'): ?> selected <?php endif; ?>>Manajemen (S1)</option>
	                      </select>
	                    </div>
			              </div>
			    				</div>
          ...
          <div class="row ftco-animate">
            <div class="col-md-12 wrap-about">
                <div class="text-center">
                    <img src="<?php echo e(asset('vendor/vonso/FlowchartV1.jpg'), false); ?>" class="img-fluid" alt="...">
                  </div>
               </div>
          </div>
        </div>
    ...
    <section class="ftco-section bg-light">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h2>Ruangan</h2>
            <p class="justify-content-center"><a href="<?php echo e(route('rooms'), false); ?>">Lihat lebih banyak ruangan disini.</a></p>
          </div>
        </div>
                    ...
                    <div class="room-wrap d-md-flex">
                        ...
                        <div class="half left-arrow d-flex align-items-center">
                            <div class="text p-4 p-xl-5 text-center">
                                ...
                                <h3 class="mb-3"><a href="javascript:void(0)"><?php echo e($room->name, false); ?></a></h3>
                                <ul class="list-accomodation">
                                    <li><span>Maks:</span> <?php echo e($room->max_people, false); ?> Orang</li>
                                    <li><span>Status:</span> <?php echo e(App\Enums\RoomStatus::getDescription($room->status), false); ?></li>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\kirana\o\pinjam-ruang\resources\views/index.blade.php ENDPATH**/ ?>