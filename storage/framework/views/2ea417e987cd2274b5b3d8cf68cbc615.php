...
<div class="container">
  ...
  <div class="collapse navbar-collapse" id="ftco-nav">
    <ul class="navbar-nav ml-auto">
        <li class="nav-item <?php if(\Request::is('/')): ?> active <?php endif; ?>"><a href="/" class="nav-link">Beranda</a></li>
        ...
        <li class="nav-item <?php if(\Request::is('rooms')): ?> active <?php endif; ?>"><a href="<?php echo e(route('rooms'), false); ?>" class="nav-link">Daftar Ruangan</a></li>
...
<!-- END nav -->
<?php /**PATH D:\kirana\o\pinjam-ruang\resources\views/includes/header.blade.php ENDPATH**/ ?>